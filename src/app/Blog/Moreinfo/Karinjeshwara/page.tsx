...
const page = () => {
  return (
    ...
    <h1 className=' text-3xl text-black text-center justify-center'>About Karinjeshwara temple</h1>
    <p className='m-[30px] justify-center'>Sri Karinjeshwara Temple is Hindu Temple, a famous Lord Shiva temple located Karinja in Bantwala 
    ...
    There are ponds named Gadha teertha at hill bottom, Ungusta theerta at hill middle.Halfway up the mountain sits the temple of Parvathi.
     ...
     stepping on the huge stone to reach this temple. In the starting point of Parvathi temple, you can see the Vinayaka Gudi. </p>
       <p className='m-[30px] justify-center'>Shiva temple is situated on the top of a hill, 1500 ft high from sea level, looks like temple is standing on a huge stone. 
