...
const Resume = () => {
  return (
    <>
    <Navbar/>
    <p className='text-5xl  text-center text-white'>RESUME</p>
    <div className='w-full h-[1380px]  '>
      <button className={styles.button} >
        <a href='/CHANDANA_T.pdf' download='Resume.pdf'>Download</a>
          ...
          <h1 className='text-1xl text-white'>Chandana T</h1>
          <p className='text-white'>Bangalore-Karnataka|9591619527|chandanaraj2001@gmail.com</p>
          <p className='text-white'>https://www.linkedin.com/in/chandana-t-51b0531a2 </p>
          <p className='text-white'>https://github.com/ChandanaT-hub</p><br></br>
          <h1 className='text-2xl text-center text-pink-800'>Career objective</h1>
          <p className='text-white'>Seeking position to utilize my skills and abilities in the information technology
    ...
    <h1 className='text-2xl text-white'>Employee Management System</h1>
    <p className='text-white'>Designed and implemented employee Management System to streamline HR processes, views for CRUD operations,and integrated user authentication for admin access.
                <br></br>Technologies:Django, Python, SQLite, HTML, CSS.</p>
                <br></br>
            
      <h1 className='text-2xl text-white'>Portfolio Website</h1>
      <p className='text-white'>Designed Crafted with precision and powered by the dynamic Django framework, this portfolio website seamlessly blends aesthetics with functionality. 
      ...
      , it features an intuitive admin panel for effortless addition of the most recent accomplishments and details.
        ...
        <h1 className='text-2xl text-center text-pink-800'>Work Experience</h1>
        <p className='text-white'>Currently working for Payrup as Software Engineer Intern. As a full stack developer intern
