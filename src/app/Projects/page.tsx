...
const projects = () => {
  return (
    ...
    <p className='text-5xl text-white text-center mt-5'>My Projects</p>


    <div className='flex rounded-3xl ml-[100px] mb-10 w-[300px] h-[400px] mt-20  bg-no-repeat hover:scale-110 transition duration-500 cursor-pointer'
       style={{backgroundImage:`url(${I1.src})`}}>  
      
   
        <div className={styles.content}>
        <p className='text-3xl text-pink-600'>Library Management system</p>
        <p className='text-1xl w-[600px] text-white '>I developed a comprehensive Library Management System utilizing a range of cutting-edge technologies to streamline
         ...
         <p className='text-1xl w-[600px] text-white'>The Library Management System represents a sophisticated solution tailored to the specific needs of library management. By leveraging Django,
    ...
    <div className={styles.div}
      ...
      <p className='text-3xl text-pink-600'>To Do App</p>
        <p className='text-1xl w-[600px] text-white'>I designed and implemented a robust To-Do application utilizing Django, Python, SQLite, HTML, and 
    ...
    <div className={styles.div1}
      ...
      <div className= {styles.content}>
      <p className='text-3xl text-pink-600 '>Portfolio Website</p>
        <p className='text-1xl w-[600px] text-white'>Crafted with meticulous attention to detail, my portfolio website represents a fusion of aesthetic appeal and seamless
